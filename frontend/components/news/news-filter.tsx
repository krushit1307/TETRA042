...
import { SupportedLanguage, LANGUAGES } from "@/lib/news-service"
    ...
    return (
        <div className="flex items-center gap-3 bg-white dark:bg-slate-900 p-3 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <span className="hidden sm:inline">Select Language:</span>
            </div>
                ...
                <SelectContent>
                    {LANGUAGES.map((lang) => (
                        <SelectItem key={lang.code} value={lang.code} className="cursor-pointer">
                            <span className="font-medium mr-2">{lang.localName}</span>
